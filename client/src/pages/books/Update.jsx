...
const Update = ({ match }) => {
  ...
  useEffect(() => {
    axios.get(`https://mern-mvc-l0h9.onrender.com/api/books/${match.params._id}`).then(response => {
  ...
  useEffect(() => {
    axios.get('https://mern-mvc-l0h9.onrender.com/api/authors/').then(response => {
      setAuthors(
  ...
  const handleFormSubmission = () => {
    axios
      .put(`https://mern-mvc-l0h9.onrender.com/api/books/${match.params._id}`, book)
